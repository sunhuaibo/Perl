...
#        $hash{$key}.="$key1\t$taxon{$key1}\n";
	...
	if($number==5){
		print OUT "
venn<-venn.diagram(list($list),filename='Venn_4set_pretty.tiff',margin=0.1,cat.fontface='bold',cex = c(1.5, 1.5, 1.5, 1.5, 1.5, 1, 0.8, 1, 0.8, 1, 0.8, 1, 0.8, 1, 0.8, 1, 0.55, 1, 0.55, 1, 0.55, 1, 0.55, 1, 0.55, 1, 1, 1, 1, 1, 1.5),col = 'white',alpha = 0.50,lwd =1.2,fill=fivecol[1:$number],fontfamily = 'Times',cat.col =fivecol[1:$number])
